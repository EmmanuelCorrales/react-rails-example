var QuizItem = React.createClass({
  ...
  evaluateAnswer() {
    ...
    if (!isNaN(user_answer)){
      user_answer = this.numberToEnglish(user_answer);
    }
    console.log("user_answer = " + user_answer);

    var correct_answer = this.props.question.answer.toLowerCase();
  ...
  render() {
    ...
    return (
      <div>
        ...
        <input ref='user_answer' type='text' placeholder='Enter your answer.' />
        {this.evaluateAnswer()}
      </div>
    )
  }
